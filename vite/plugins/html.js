    ...
    const html = htmlPlugin({
        inject: {
            injectData: {
                ...
                copyrightScript: `
<script>
console.info('%c由%ctrry%c提供技术支持', '${copyright_sub_style}', '${copyright_main_style}', '${copyright_sub_style}', '\\nhttps://hooray.gitee.io/trry/');
console.info('%cPowered by%ctrry', '${copyright_sub_style}', '${copyright_main_style}', '\\nhttps://hooray.github.io/trry/');
</script>
                `
            }
        },
